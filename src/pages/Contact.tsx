            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">📞 +92 21 1234 5678, +92 301 3926202</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">✉️ info@bigbosspizza.com</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">📍 Safa Heights, Precinct 11A Commercial, Bahria Town Karachi</p>
                  <p className="text-sm text-gray-500 mt-1">Visit us for dine-in experience</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Mon–Sun: 05:00PM – 03:00AM</p>
